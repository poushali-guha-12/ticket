...
createElement("div", document.body, {id:"maindiv"}, {boxShadow: "0px 0px 100px #87CEEB",position:"relative", margin:"auto", height:"100%", width:"60%"}, "");
...
(function ticketView() {
    ...
    createElement('div', div3, {id:'divHeader'}, {position:'absolute', top:'6%', height:'50%', width:'100%', borderBottom:'1px solid blue'}, "");
    createElement('input', divHeader, {id:'id1', placeholder:'id'}, {position:'absolute', left:"2%", top:"5%", height:'30%', width:'20%'}, "");
    createElement('input', divHeader, {id:'header', placeholder:'Header'}, {position:'absolute', left:"27%", top:"5%", height:'30%', width:'30%'}, "");
    createElement('input', divHeader, {id:'ticketName', placeholder:'Name'}, {position:'absolute', right:"7%", top:"5%", height:'30%', width:'20%'}, "");
    createElement('button', divHeader, {id:'cancel'}, {position:'absolute', right:"2%", top:"5%", height:'20%', width:'3%', cursor: "pointer", backgroundColor:"white"}, "X");
    createElement('a', divHeader, {id:'confirm', value:"true"}, {position:'absolute', right:"8%", bottom:"35%", cursor:'pointer'}, "confirm");
    createElement('a', divHeader, {id:"reject", value:"false"}, {position:'absolute', right:"2%", bottom:"35%", cursor:'pointer'}, "/ reject");
    createElement('button', divHeader, {id:'arrow'}, {position:"absolute", left:"48%", bottom:"0%", height:'15%',width:'3%', cursor: "pointer"}, "-");
    createElement('div', div3, {id:'divDescription'}, {position:'absolute', bottom:'10%', height:'40%', width:'100%'}, "");
    createElement('textarea', divDescription, {id:'textarea', placeholder:'Description'}, {position:'absolute', top:"10%", height:'80%', width:'80%', margin:'2%'}, "");
    createElement('button', div3, {id:'export1'}, {position:'absolute', right:'2%', top:'42%', height:'12%', width:'10%', cursor: "pointer", backgroundColor:"white"}, "Export");
})();

(function insertThread() {
    createElement("div", maindiv, {id:"div4"}, {position:"absolute", bottom:"1%", height:"30%", width:"100%"}, "");
